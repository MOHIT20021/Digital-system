...
HD_PWD='C:/Users/mohit/Desktop/DIGITAL SYSTEM/FNN/TRIALS/Receiving_UART/Receiving_UART.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Receiving.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Receiving.tcl -notrace
