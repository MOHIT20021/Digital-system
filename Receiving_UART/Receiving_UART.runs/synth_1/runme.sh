...
HD_PWD='C:/Users/mohit/Desktop/DIGITAL SYSTEM/FNN/TRIALS/Receiving_UART/Receiving_UART.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Receiving.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Receiving.tcl
